...
DATA_FILES = {
    "projekt": os.path.join("1_projektutveckling", "PU_3_projekt.csv"),
    "markexpansion": os.path.join("1_projektutveckling", "PU_4_markexpansion.csv"),
    "btabya": os.path.join("1_projektutveckling", "PU_4_BTABYA.csv"),
    "poldia": os.path.join("1_projektutveckling", "PU_4_poldia.csv"),
    "poldia_spec": os.path.join("1_projektutveckling", "PU_4_poldia_spec.csv"),
    "bradet": os.path.join("1_projektutveckling", "PU_Projektutvecklingsbrädet.xlsx"),
    "leverantorer": os.path.join("2_planering", "PL_4_Leverantörer.csv"),
    "organisation": os.path.join("2_planering", "PL_4_Organisation.csv"),
    "handelsekort_pl": os.path.join("2_planering", "PL_4_Händelsekort.csv"),
    "faskort": os.path.join("3_genomforande", "GF_3_Faskort.csv"),
    "kultur": os.path.join("3_genomforande", "GF_4_kultur.csv"),
    "konsekvenskort": os.path.join("3_genomforande", "GF_4_konsekvenskort.csv"),
    "garantibesiktning": os.path.join("3_genomforande", "GF_4_garantibesiktning.csv"),
    "personal": os.path.join("4_forvaltning", "F_4_personal.csv"),
    "yield": os.path.join("4_forvaltning", "F_4_yield.csv"),
    "dd": os.path.join("4_forvaltning", "F_4_DD.csv"),
